const messages = {
  msg: {
    ...
    //modal
    passwordTitle:"输入您的钱包密码",
    registerTitle:"创建新用户名！",

    cancel:'撤销',
    save: '保存',
    welcome: '欢迎使用DiagonAlley钱包',
    msg: '消息',
    more: '更多',
    back: '返回',
    ...
    remove:{
      ...
      remove: '移除钱包',
      success: '当前钱包已经移除，请重启DiagonAlley'
    },
    ...
    hedwig: {
      ...
      intro2: '当有人向这个临时地址发送grin时，它会把这个发币请求转发到你的DiagonAlley钱包，完成交易.',
      start: '启动',
