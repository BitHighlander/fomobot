const messages = {
  msg: {
    ...
    //modal
    passwordTitle:"введите пароль своего кошелька",
    registerTitle:"Создать новое имя пользователя!",

    cancel:'Отменить',
    save: 'Сохранить',

    welcome: 'Добро пожаловать в DiagonAlley кошелек',
    ...
    app:{
      ...
      updateMsg: 'Найдена новая версия DiagonAlley кошелка. Обновить прямо сейчас?',
      yes: 'Да',
      no: 'Нет',
