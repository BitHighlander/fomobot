...
module.exports = function gdax (conf) {
    ...
    var exchange = {
        ...
        getTrades: function (opts, cb) {
            ...
            console.log(tag, "get trades! opts: ",opts)

            console.log("start: ",moment(opts.from).calendar())
            console.log("end: ",moment(opts.to).calendar())
            ...
            bitmex.Trade.get({symbol:"XBT:monthly",count:"500",startTime:opts.from,endTime:opts.to})
                .then(function(resp){
