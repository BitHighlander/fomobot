 ...
 */
const TAG = " | SIM | "
let {modelfile,backtestDir} = require("./config")
    ...
    try{
        require('mongodb').MongoClient.connect(connectionString, { useNewUrlParser: true }, function (err, client) {
            ...
            let so = {
                ...
                period: '30m',
                filename: backtestDir+'temp.571132ce3df3aeea6415aafce5b5e326c9b374cec182af5cf7c2c23982b6af0c-20190820_041537+0000.json-simTrainingResult.html',
                quarentine_time: 10,
                sell_stop_pct: 0,
                buy_stop_pct: 0,
                profit_stop_enable_pct: 0,
