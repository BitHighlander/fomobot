...
let objectifySelector = require('../../lib/objectify-selector')
...
//     '--disable_options',
//     '--modelfile',
//     '/home/highlander/home/highlander/.fomobro/temp.571132ce3df3aeea6415aafce5b5e326c9b374cec182af5cf7c2c23982b6af0c-20190820_041537+0000.json',
//     '--start',
//     '201908192215',
//     '--end',
//     '201908192200',
...
//     '30m',
//     '--filename',
//     '/home/highlander/home/highlander/.fomobro/temp.571132ce3df3aeea6415aafce5b5e326c9b374cec182af5cf7c2c23982b6af0c-20190820_041537+0000.json-simTrainingResult.html' ]
...
//     period_length: "30m",
//     strategy: "forex_analytics",
//     modelfile: "/home/highlander/.fomobro/temp.571132ce3df3aeea6415aafce5b5e326c9b374cec182af5cf7c2c23982b6af0c-20190820_041537+0000.json",
//     filename: "/home/highlander/.fomobro/temp.571132ce3df3aeea6415aafce5b5e326c9b374cec182af5cf7c2c23982b6af0c-20190820_041537+0000.json-simTrainingResult.html"
// }
...
require('mongodb').MongoClient.connect(connectionString, {useNewUrlParser: true}, function (err, client) {
    ...
    let so = { strategy: 'forex_analytics',
        disable_options: true,
        modelfile:
            '/home/highlander/WebstormProjects/fomo-core/services/simulate/models/temp.06386bd67dd782a007ba18193c5bfa4f4e6fd42a57849b3db7b5ba911f1eb9db-20190927_040010+0000.json',
        start: 1565481600000,
        end: NaN,
        period: '30m',
        filename:
            '/home/highlander/WebstormProjects/fomo-core/services/simulate/models/temp.06386bd67dd782a007ba18193c5bfa4f4e6fd42a57849b3db7b5ba911f1eb9db-20190927_040010+0000.json-simTrainingResult.html',
        quarentine_time: 10,
        sell_stop_pct: 0,
        buy_stop_pct: 0,
        profit_stop_enable_pct: 0,
    ...
    so.stats = false
    so.show_options = false
    so.verbose = false
    so.selector = objectifySelector(false || conf.selector)
    so.mode = 'sim'

    // console.log(tag,"s: ",s)
    // console.log(tag,"conf: ",conf)

    var engine = engineFactory(s, conf)
    if (!so.min_periods) so.min_periods = 1
    var cursor, reversing, reverse_point

    console.log(tag,"so.start: ",so.start)
    console.log(tag,"so.period_length: ",so.period_length)
    console.log(tag,"so.min_periods: ",so.min_periods)
